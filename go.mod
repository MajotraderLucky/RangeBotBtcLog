...
require (
	github.com/MajotraderLucky/MarketRepository v0.0.0-20231012050009-c3070661396d // indirect
	github.com/MajotraderLucky/Utils v0.0.0-20231010235318-416edd9d940b // indirect
